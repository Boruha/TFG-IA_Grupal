...
\usepackage{natbib}
\usepackage{siunitx} %alinear numeros decimales en tablas {s}
...
% ********************************************************************
\newcommand{\myTitle}{Gestión y manejo de comportamientos grupales de entidades en videojuegos}
...
%\input{capitulos/preliminares con agradecimientos}
