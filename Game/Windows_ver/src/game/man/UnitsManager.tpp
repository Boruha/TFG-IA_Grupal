...
UnitsManager::loadLevel0() { 
    ...
    pat1.points = { 
        fvec2<fint_t<int64_t>> ( ( -920l ), ( -550l ) )
      , fvec2<fint_t<int64_t>> ( ( -750l ), ( -150l ) )
      , fvec2<fint_t<int64_t>> ( ( -430l ), (    0l ) )
      , fvec2<fint_t<int64_t>> ( ( -250l ), ( -300l ) ) 
    };

    auto& pat2  = patrols.emplace_back();
    pat2.points = { 
        fvec2<fint_t<int64_t>> ( ( -700l ), (  450l ) )
      , fvec2<fint_t<int64_t>> ( (  -50l ), ( -150l ) )
      , fvec2<fint_t<int64_t>> ( (  300l ), ( -150l ) )
      , fvec2<fint_t<int64_t>> ( (  300l ), (  450l ) ) 
    };

    auto& pat3  = patrols.emplace_back();
    pat3.points = { 
        fvec2<fint_t<int64_t>> ( (  900l ), ( -400l ) )
      , fvec2<fint_t<int64_t>> ( (  750l ), ( -130l ) )
      , fvec2<fint_t<int64_t>> ( (    0l ), ( -170l ) )
      , fvec2<fint_t<int64_t>> ( ( -150l ), ( -450l ) ) 
    };
...
UnitsManager::loadLevel1() {
    ...
    auto& pat1  = patrols.emplace_back();
    pat1.points = { 
        fvec2<fint_t<int64_t>> ( ( -1820l ), ( -650l ) )
      , fvec2<fint_t<int64_t>> ( (  -950l ), (  150l ) )
      , fvec2<fint_t<int64_t>> ( (  -150l ), ( -650l ) )
      , fvec2<fint_t<int64_t>> ( (  -950l ), ( -850l ) ) 
    };

    auto& pat2  = patrols.emplace_back();
    pat2.points = { 
        fvec2<fint_t<int64_t>> ( (  100l ), (  250l ) )
      , fvec2<fint_t<int64_t>> ( (  600l ), (   50l ) )
      , fvec2<fint_t<int64_t>> ( ( 1400l ), ( -700l ) )
      , fvec2<fint_t<int64_t>> ( (    0l ), ( -400l ) ) 
    };
