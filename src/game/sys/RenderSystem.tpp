...
// Colliders2DCmp_t
    ...
    auto screen_coords { continuousToScreen(mov.coords) };

    engine->drawRect(screen_coords.x, screen_coords.y, uSize_x, uSize_y, static_cast<uint32_t>(Color::Purple), false);
